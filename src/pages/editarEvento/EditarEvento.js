...
function getEventoById(id) {
  ...
  return override[String(id)] || base.find((e) => String(e.id) === String(id)) || null;
}
...
const EditarEvento = () => {
  ...
  useEffect(() => {
    ...
    if (usuarioLogado?.faculdadeId && evento.instituicaoId !== usuarioLogado.faculdadeId) {
      Swal.fire({
        title: "Acesso negado",
      ...
      <div className="card-form">
        ...
        <div className="formulario">
          ...
          <div className="campo">
            ...
            {/* Idêntico ao CriarEvento, mas calendário fica travado */}
          ...
          {/* Data do evento (sempre aparece, porque calendário é true) */}
          <div className="campo">
